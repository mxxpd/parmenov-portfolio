  ...
  >
    ...
    <div class="issues">
      <div class="issue">
        ...
        <p class="issue__text">
          Слабые игроки попадали к сильным и уходили. Среднее — 3 матча на
          пользователя. Причина не в интерфейсе, а в отсутствии рейтинговой
          системы. Я предложил как минимальное решение ограничить матчмейкинг по
          диапазону рейтинга уже на старте — без полноценной системы лиг это дало
          бы базовую защиту новичков. Реализовать не успели: финансирование
          закончилось раньше.
        </p>
      </div>
      <div class="issue">
        ...
        <p class="issue__text">
          Часть пользователей создавала несколько аккаунтов для получения
          бонусов. Потребовалась дополнительная верификация через Steam.
        </p>
      </div>
    </div>
    ...
    <figure
      ...
      aria-label="Схема проблемного цикла: мало пользователей ведёт к плохому матчмейкингу, плохому опыту и оттоку"
    >
